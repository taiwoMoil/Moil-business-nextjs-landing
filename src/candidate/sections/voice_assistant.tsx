          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF6633]/10 rounded-full border border-[#FF6633]/20">
                ...
                <span className="text-[#FF6633] text-sm font-medium">AI-Powered</span>
              </div>
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Voice Interview <span className="text-[#FF6633]">Coaching</span>
              </h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                Master interviews with real-time AI analysis of your speech, confidence, and answers. Get instant feedback to improve your performance.
              </p>
            </div>
            
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
                <div className="text-3xl font-bold text-[#FF6633] mb-2">94%</div>
                <div className="text-gray-700 font-medium">Success Rate</div>
              </div>
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
                <div className="text-3xl font-bold text-[#FF6633] mb-2">4.8/5</div>
          ...
          <div className="relative">
            <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/50">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900">AI Interview Coach</h4>
                  <p className="text-gray-600">Master your next interview with confidence</p>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="w-20 h-full bg-[#FF6633] rounded-full"></div>
                    </div>
                    <span className="text-[#FF6633] font-semibold">85%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="w-22 h-full bg-[#FF6633] rounded-full"></div>
                    </div>
                    <span className="text-[#FF6633] font-semibold">92%</span>
                  </div>
                </div>
              </div>
            </div>
